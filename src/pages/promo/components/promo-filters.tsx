...
import { Building2, Filter, Layers, Plus, RefreshCw, Search } from "lucide-react";
        ...
        <div className="flex flex-col gap-2 lg:flex-row lg:items-center">
          <div className="flex min-w-[320px] flex-1 flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm shadow-sm border border-slate-300 h-9 px-3 min-w-[150px]">
              <Layers className="h-4 w-4" style={{ color: "#3b91f9" }} />
              <select
                value={typeFilter}
          ...
          <div className="flex flex-1 flex-wrap items-center justify-end gap-4">
            <div className="flex items-center gap-3 bg-white/80 backdrop-blur-sm px-3 shadow-sm border border-slate-300 h-9">
              ...
              <div className="flex flex-col items-center justify-center">
                <span className="text-slate-500 text-[9px] font-medium leading-none">Berakhir</span>
                <span className="font-bold text-xs text-amber-600 leading-none mt-0.5">{stats.expired}</span>
              </div>
            </div>
