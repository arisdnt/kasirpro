                ...
                <Table className="min-w-full text-sm">
                  <TableHeader className="sticky top-0 z-10 bg-white/95">
                    <TableRow className="border-b border-slate-200">
                      <TableHead className="w-[25%] text-slate-500">No. Retur</TableHead>
                      <TableHead className="w-[25%] text-slate-500">Pelanggan</TableHead>
          ...
          <CardContent className="flex flex-1 min-h-0 flex-col gap-4 overflow-hidden">
            {selectedReturn ? (
              <>
                <div className="shrink-0 rounded-none border border-slate-200 bg-white p-4 shadow-inner">
                  <dl className="space-y-3 text-sm text-slate-600">
                    <div>
                      <dt className="text-xs uppercase tracking-wide text-slate-500">No. Retur</dt>
                      <dd className="font-bold text-lg text-slate-900">{selectedReturn.nomorRetur}</dd>
                    </div>
                    <div>
                      <dt className="text-xs uppercase tracking-wide text-slate-500">Pelanggan</dt>
                      <dd className="font-semibold text-slate-900">{selectedReturn.pelangganNama ?? "Tanpa pelanggan"}</dd>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <dd className="font-bold text-2xl text-red-600">{formatCurrency(selectedReturn.total)}</dd>
                    </div>
                  </dl>
                </div>
                ...
                <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-none border border-slate-200 bg-white">
                  ...
                  <div className="flex-1 p-4">
                    <div className="space-y-3 text-sm">
                      ...
                      <div>
                        <span className="text-xs uppercase tracking-wide text-slate-500">Alasan</span>
                        <p className="text-slate-700">{selectedReturn.alasan ?? "-"}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-1 flex-col items-center justify-center gap-2 text-center text-slate-500">
                ...
                <p className="text-xs text-slate-500">
                  Klik salah satu baris untuk melihat informasi lengkap retur penjualan.
                </p>
              </div>
            )}
          </CardContent>
