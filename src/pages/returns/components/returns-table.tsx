                ...
                <TableBody>
                  {filteredReturns.map((item) => (
                    ...
                    >
                      ...
                      <TableCell className={cn("align-top", item.id === selectedId ? "text-black" : "text-slate-700")}>
                        {item.nomorTransaksiPenjualan ?? "-"}
                      </TableCell>
                      <TableCell className={cn("align-top", item.id === selectedId ? "text-black" : "text-slate-700")}>
                        {item.pelangganNama ?? "Tanpa pelanggan"}
                      </TableCell>
                      <TableCell className={cn("align-top font-semibold", item.id === selectedId ? "text-black" : "text-slate-900")}>
                      ...
                      <TableCell className={cn("align-top text-xs", item.id === selectedId ? "text-black" : "text-slate-600")}>
