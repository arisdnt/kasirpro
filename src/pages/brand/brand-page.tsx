...
import { Filter, Tag, Plus, RefreshCw, Search } from "lucide-react";
                    ...
                    {filteredBrands.map((item) => (
                      ...
                      >
                        ...
                        <TableCell className="align-top">
                          ...
                          >
                            {item.tokoId ? "Brand Toko" : "Brand Global"}
                          </Badge>
                        </TableCell>
                  ...
                  <dl className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm text-slate-600">
                    ...
                    <div>
                      ...
                      <dd className="font-medium text-slate-900">
                        {selectedBrand.tokoId ? "Brand Toko" : "Brand Global"}
                      </dd>
                    </div>
                    <div className="col-span-2">
                      <dt className="text-xs uppercase tracking-wide text-slate-500">Toko</dt>
                      <dd className="font-medium text-slate-900">
                        {selectedBrand.tokoId ?? "Semua toko"}
                      </dd>
                    </div>
                  </dl>
                </div>
